...
- Use the `/help` slash command!
- Join the conversation in <#{{DEFAULTTEXTCHANNEL}}> and connect with others!

-# Your privacy matters to us. Learn more about how we safeguard your data [here](<https://wixonic.fr/privacy/#specific-use-cases>).

Thank you for reading the rules! Enjoy your time in {{GUILDNAME}}!